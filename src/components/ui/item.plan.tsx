...
export const PlanItem: FC<{
  ...
  return (
    <li
      className={clsx(
        'max-h-[822px] w-full max-w-[394px] min-w-[360px] overflow-hidden rounded-[36px] p-[1px] sm:h-[822px]',
        className,
      )}
    >
      <div className="relative flex h-full w-full flex-col overflow-hidden rounded-[36px]">
        ...
        <div className="z-10 flex h-full flex-col p-6">
          <div className="font-gotham-xnarrow text-[40px] leading-12 font-bold">
            {title}
          </div>
          <div className="mt-2 text-[18px] leading-5 text-[#9990AB]">
            {description}
          </div>

          {fullPrice && price && savingTitle && (
            <>
              ...
              <div className="my-4">
                <span className="text-[60px] leading-10 font-bold">
                  ${price}
                </span>{' '}
          ...
          <div className="mt-auto flex justify-between max-sm:mt-8">
            <Button
              variant="filled"

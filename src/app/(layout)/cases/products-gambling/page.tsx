    ...
    <Fragment>
      ...
      <div className="flex flex-col py-[35px] md:py-[70px]">
        ...
        <section className="px-[16px] pt-[30px] md:pt-[40px]">
          ...
          <div className="mx-auto grid max-w-[1128px] grid-cols-13 gap-1.5 max-md:hidden max-md:grid-cols-1 md:gap-4">
          ...
          <div className="mx-auto mt-5 grid grid-cols-2 gap-1.5 max-md:grid-cols-1 md:mt-8 md:max-w-[816px] md:gap-4">
